...
import (
	...
	"github.com/example/apply-ai/dashboard/internal/data"
	"github.com/example/apply-ai/dashboard/internal/model"
	"github.com/example/apply-ai/dashboard/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("ApplyAI")
