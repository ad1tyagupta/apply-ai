...
const CANONICAL_REPO = 'https://github.com/your-org/apply-ai.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/your-org/apply-ai/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/your-org/apply-ai/releases/latest';

function updaterConfigured() {
  return !CANONICAL_REPO.includes('your-org/');
}
...
async function check() {
  if (!updaterConfigured()) {
    console.log(JSON.stringify({
      status: 'unconfigured',
      message: 'Set your canonical repository URLs in update-system.mjs before using updater commands.',
    }));
    return;
  }
...
async function apply() {
  if (!updaterConfigured()) {
    console.error('Updater is not configured. Replace placeholder repository URLs in update-system.mjs first.');
    process.exit(1);
  }
